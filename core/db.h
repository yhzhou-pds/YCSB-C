...
class DB {
 public:
  ...
  ///
  virtual int Update(uint64_t pinode , std::string& fname , uint64_t inode) = 0;
  ///
  ...
  /// @return Zero on success, a non-zero error code on error.
  ///
  virtual int Insert(uint64_t pinode , std::string& fname , uint64_t inode) = 0;
  ///
  ...
  /// @return Zero on success, a non-zero error code on error.
  ///
  virtual int Delete(uint64_t pinode , std::string& fname) = 0;
